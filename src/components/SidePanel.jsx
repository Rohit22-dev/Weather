...
const SidePanel = () => {
  ...
  return (
    <div className=" m-8 rounded-lg md:w-1/4 h-[40rem] md:h-screen overflow-scroll flex flex-col items-center p-5 py-16 bg-dark_teal">
      ...
      <div className="flex flex-wrap gap-5 justify-center w-full mt-8">
        {data &&
          data.map((item, i) => {
            return (
              <div
                className="flex flex-col shadow-inner shadow-dark items-center w-36 rounded-lg p-2 px-4 cursor-pointer"
                key={i}
              >
                ...
                <div className="flex items-center justify-evenly w-full">
                  <img src={item.day.condition.icon} className="w-12" />
